...
# Error Messages
# -----------------------------
missing_config_error = """Missing Required Configuration

It looks like you forgot to fill in some required settings in the config.ini file.
The following settings are missing:
{}

Please check the documentation or contact the developer @bohd4nx for help.
...
gift_expensive = "Gift: \033[1m{}\033[0m does not match the user's specified settings."
